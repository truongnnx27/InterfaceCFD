              ...
              <div class="media">
                <div class="d-flex media-wide">
                  ...
                  <div class="media-body">
                    ...
                    <h5>{{ wish.price }}</h5>
                    <div class="remove-btn">
                      <a href="#" class="btn" style="background-color: blanchedalmond; color: black;" @click.prevent="addToCart(wish)">Add to cart</a>
...
export default {
  setup() {
    ...
    const fetchWishlist = async () => {
      try {
        const response = await axios.get(`http://localhost:8080/identity/api/v1/wishlist/getAllWS/${userId}`);
        console.log("API Response:", response.data); 
        wishlist.value = response.data.result;  // Truy cập vào result
        console.log("Fetched Wishlist:", wishlist.value); 
      } catch (error) {
    ...
    const unWishlist = async(id) =>{
      try{
        await axios.delete(`http://localhost:8080/identity/api/v1/wishlist/${id}`);
