            ...
            <div class="product-content">
                <div class="course-group d-flex">
                    <div class="course-group-img d-flex">
                        <router-link to="/instructor/instructor-profile"><img
                ...
                <h3 class="title instructor-text"><router-link
                        to="/course/course-details">Learn Angular
        ...
        <div class="product">
            ...
            <div class="product-content">
                <div class="course-group d-flex">
                    <div class="course-group-img d-flex">
                        <router-link to="/instructor/instructor-profile"><img
                                src="@/assets/img/user/user6.jpg" alt="Img"
                                class="img-fluid"></router-link>
                        <div class="course-name">
                ...
                <h3 class="title instructor-text"><router-link
                        to="/course/course-details">Learn JavaScript and
    ...
    <div class="course-box flex-fill">
        <div class="product">
            ...
            <div class="product-content">
                ...
                <h3 class="title instructor-text"><router-link
                        to="/course/course-details">Introduction to
