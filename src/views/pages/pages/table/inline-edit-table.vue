  ...
  <div class="app-container">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="dialogStatus==='create'?createData():updateData(category)">
          Confirm
        </el-button>
      </div>
    </el-dialog>
...
export default {
  ...
  methods: {
    getList() {
      ...
      axios.get(API_URL + "/getCategorys")
      .then(response => {
      ...
      .catch(error => {
        console.log("Tải dữ liệu thất bại", error)
      })
    },
    createData() {
      axios.post(API_URL + "/postCategory", this.category)
      .then(() => {
      ...
      .catch((error) => {
        console.log("Thêm category thất bại", error)
      })
    },
    handleDelete(idCategory) {
      axios.delete(API_URL + `/deleteCategory/${idCategory}`)
      .then(() => {
      ...
      .catch((error) => {
        console.log("Xóa category thất bại", error)
      })
    },
    updateData(category) {
      axios.put(API_URL + `/putCategory/${category.id}`, category)
      .then(() => {
        this.getList()
        this.dialogFormVisible = false
        this.category.categoryName = ''
      ...
      .catch(() => {
        console.log("Chỉnh sửa category thất bại", error)
      })
